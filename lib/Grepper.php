...
class Grepper
{
    /** @var string The Grepper API key to be used for requests. */
    public static $apiKey;

    /** @var string The Grepper client_id to be used for Connect requests. */
    public static $clientId;

    /** @var string The base URL for the Grepper API. */
    public static $apiBase = 'https://api.grepper.com';

    /** @var string The base URL for the OAuth API. */
    public static $connectBase = 'https://connect.grepper.com';

    /** @var string The base URL for the Grepper API uploads endpoint. */
    public static $apiUploadBase = 'https://files.grepper.com';

    /** @var null|string The version of the Grepper API to use for requests. */
    ...
    /** @var float Maximum delay between retries, in seconds, that will be respected from the Grepper API */
    ...
    /**
     * @return null|string The Grepper account ID for connected account
     *   requests
     */
    ...
    /**
     * @param null|string $accountId the Grepper account ID to set for connected
     *   account requests
     */
    ...
    /**
     * @return float Maximum delay between retries, in seconds, that will be respected from the Grepper API
     */
     ...
     *
     * Client telemetry enables timing and request metrics to be sent back to Grepper as an HTTP Header
     * with the current request. This enables Grepper to do latency and metrics analysis without adding extra
